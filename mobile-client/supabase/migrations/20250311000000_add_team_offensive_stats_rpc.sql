-- RPC to get per-team offensive stats: per-game averages from actual game box scores
-- Used for Seasonal Breakdown "team average" mode (vs per-player average from roster)

CREATE OR REPLACE FUNCTION get_team_offensive_stats(p_season int DEFAULT 2026, p_season_type int DEFAULT 2)
RETURNS TABLE (

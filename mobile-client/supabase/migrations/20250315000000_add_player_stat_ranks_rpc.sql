-- RPC to get league-wide stat ranks for specific players
-- Used for mismatch alerts to show player's league rank (e.g. "#5 in RPG")
...
AS $$
  ...
  SELECT athlete_id, ppg_rank, rpg_rank, apg_rank, spg_rank, bpg_rank
  FROM ranked
